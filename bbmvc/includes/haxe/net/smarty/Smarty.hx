...
// This interface is compatibly with Smarty 3.x only 
// And we encourage you to stay on Smarty 3 (Smarty 4,5 documentation sucks so we won't add support)
...
extern class Smarty {
    ...
    public function registerDefaultPluginHandler(_callback : Dynamic) : Void;
    ...
    public function registerFilter(type : String, _callback : Dynamic) : Void;
    ...
    public function registerPlugin(type : String, name : String, _callback : Dynamic, cacheable : Bool, cache_attrs : Dynamic) : Void;
    ...
    public function unregisterFilter(type : String, _callback : Dynamic) : Void;
